...
class DisasterPreparednessMuseum {
    ...
    startVRTour() {
        ...
        this.showNotification('VR Tour started! Use WASD to move and click on portal rings.', 'info');
    }
            ...
            'posters': {
                ...
                content: `
                    <div class="learning-section">
                        ...
                        <p>View and download safety posters for different disaster types:</p>
                    ...
                    <div class="learning-section">
                        ...
                        <div class="videos-grid">
                            <div class="video-card">
                                <h4><i class="fas fa-play-circle"></i> Japan Earthquake Documentary</h4>
                                <div class="video-placeholder">
                                    <i class="fas fa-film fa-4x"></i>
                                    <p>Learn from the 2011 earthquake and tsunami</p>
                                </div>
                    ...
                    <div class="learning-section">
                        ...
                        <div class="artifact-viewer">
                            <div class="viewer-placeholder">
                                ...
                                <p>3D Model Viewer</p>
                                <p class="small">(In a full implementation, this would be an interactive 3D viewer)</p>
                            </div>
...
function viewPoster(posterType) {
    if (museumApp) {
        museumApp.showInfoModal(posterType.charAt(0).toUpperCase() + posterType.slice(1) + ' Safety Poster',
            `<p>This would display the ${posterType} safety poster in full screen.</p>
            <p>In a full implementation, this would show a high-resolution image with detailed safety information.</p>`);
    }
}

function playVideo(videoType) {
    if (museumApp) {
        museumApp.showInfoModal('Video Player',
            `<p>Playing ${videoType} documentary video...</p>
            <p>In a full implementation, this would embed and play an educational video.</p>`);
...
function view3DModel(modelType) {
    if (museumApp) {
        museumApp.showInfoModal('3D Model Viewer',
            `<p>Loading 3D model: ${modelType.replace('-', ' ')}</p>
            <p>In a full implementation, this would load an interactive 3D model using Three.js.</p>`);
    }
}
